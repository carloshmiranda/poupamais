...
const DESCRIPTION = "Plataforma inteligente de poupanças para consumidores portugueses";
const VALUE_PROPOSITION = "Ajudamos portugueses a poupar mais dinheiro através de dicas personalizadas e metas automatizadas";
...
const FEATURES = [
  {
    ...
    description: "Defina objetivos de poupança personalizados e acompanhe o seu progresso",
  },
  {
    icon: (
      <svg className="w-6 h-6 text-gray-900" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    description: "Receba sugestões automáticas para reduzir gastos e aumentar poupanças",
  },
  {
    icon: (
      <svg className="w-6 h-6 text-gray-900" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    description: "Visualize onde está a gastar o seu dinheiro e identifique oportunidades",
  },
];
...
const FAQS = [
  {
    q: "Como funciona o PoupaMais?",
    a: "Conecte as suas contas bancárias e defina metas. O nosso algoritmo analisa os seus gastos e sugere formas de poupar mais.",
  },
  {
    q: "É seguro conectar as minhas contas?",
    a: "Sim, utilizamos encriptação bancária e nunca armazenamos as suas credenciais. Apenas lemos informações de transações.",
  },
  {
    q: "Quanto custa o serviço?",
    a: "Oferecemos um plano gratuito básico e um plano premium por €9.99/mês com funcionalidades avançadas.",
  },
];
            ...
            <div className="flex min-h-[340px] md:min-h-[420px]">
              ...
              <div className="flex-1 p-4 md:p-6 bg-white">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6">
                  {[
                    { label: "Poupado Este Mês", value: "2,847", change: "+12.5%", up: true },
                    { label: "Meta Progresso", value: "€4,290", change: "+8.2%", up: true },
                    { label: "Dicas Seguidas", value: "94.2%", change: "-0.3%", up: false },
                  ].map((stat, i) => (
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-1">{`Conectar Contas`}</h3>
              <p className="text-sm text-gray-500">{`Ligue as suas contas bancárias de forma segura`}</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-1">{`Definir Metas`}</h3>
              <p className="text-sm text-gray-500">{`Estabeleça objetivos de poupança personalizados`}</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-1">{`Poupar Mais`}</h3>
              <p className="text-sm text-gray-500">{`Siga as nossas dicas e alcance os seus objetivos`}</p>
            </div>
          </div>
